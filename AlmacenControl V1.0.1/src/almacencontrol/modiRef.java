 ...
 * @author albert
 */
public class modiRef extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Descripcion", "Existencia", "PU"
            }
        ) {
        ...
        jLabel1.setText("Modificar Refacciones");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (int i = 0; i < fila; i++) {
            String sSQL = "UPDATE refacciones SET  cantidad= " + Integer.parseInt(m.getValueAt(i, 2).toString()) + ", pu =" + Float.parseFloat(m.getValueAt(i, 3).toString()) + ", nombre = '" + m.getValueAt(i, 1).toString() + "' where codigo ='" + m.getValueAt(i, 0).toString() + "'";

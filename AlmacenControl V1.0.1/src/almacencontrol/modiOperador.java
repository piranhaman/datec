 ...
 * @author albert
 */
public class modiOperador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modificar Mecanicos");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (int i = 0; i < fila; i++) {
            String sSQL = "UPDATE operador SET  nombre = '" + m.getValueAt(fila, 1).toString() + "', domicilio='" + m.getValueAt(fila, 2).toString() + "', telefono='" + m.getValueAt(fila, 3).toString() + "' where id =" + Integer.parseInt(m.getValueAt(fila, 0).toString());
        ...
        try {
            while (rs.next()) {
                if (rs.getString("nombre").contains(nombre)) {
                    m.addRow(new Object[]{rs.getInt("id"), rs.getString("nombre"), rs.getString("domicilio"), rs.getString("telefono")});
                }
            }

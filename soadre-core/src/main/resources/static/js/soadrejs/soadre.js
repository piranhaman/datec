...
app.factory('soadreInterceptor', function ($q, $window, $rootScope, $injector) {
    return {
        ...
        'responseError': function(rejection) {                
                var uibModalInstance = $injector.get('$uibModal').open({
                    templateUrl: 'js/soadrejs/mensaje-excepcion.html',
...
app.config(function ($httpProvider) {
  $httpProvider.interceptors.push('soadreInterceptor');
});
...
app.factory('mensajeConfirmacion', function () {
    ...
    mensajeConfirmacion.abrir = function ($uibModal, titulo, mensaje, postConfirmacion) {
        $uibModal.open({
            templateUrl: 'js/soadrejs/mensaje-confirmacion.html',
...
app.factory('mensajeInformacion', function ($rootScope) {
    ...
    mensajeInformacion.abrir = function ($uibModal, mensaje) {
        $uibModal.open({
            templateUrl: 'js/soadrejs/mensaje-informacion.html',
            controller: function ($scope, $uibModalInstance) {
                $scope.mensaje = mensaje;
                $scope.ok = function () {
                    $uibModalInstance.close();

    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().equals("")||jTextField8.getText().equals("")) {
            ...
            String nombre = jTextField1.getText();
                ...
                sSQL = "INSERT INTO  gastos (concepto, detalles, fecha, hora, costo)"
                        + "VALUES(?, ?, ?, ?, ?)";
                ...
                if(desc.length()>79){
                    JOptionPane.showMessageDialog(this, "El numero maximo de caracteres permitidos para el campo \"Detalles\" es del 80 letras");
                }else if(nombre.length()>19){
                    JOptionPane.showMessageDialog(this, "El numero maximo de caracteres permitidos para el campo \"Concepto\" es del 20 letras");
                }else{
                    try {
                        ...
                        pst.setString(3, Principal.getFecha());
                        pst.setString(4, Principal.getHora());
                        pst.setFloat(5, cos);

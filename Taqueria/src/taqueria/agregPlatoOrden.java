...
import static taqueria.Orden.jTable2;
 ...
 * @author albert
 */
public class agregPlatoOrden extends javax.swing.JFrame {

    /**
     * Creates new form agregaCompra
     */
    public agregPlatoOrden() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Agrega producto a Orden");
...
// TODO add your handling code here:
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            if (fila >= 0) {
                int a = Integer.parseInt(JOptionPane.showInputDialog("Cantidad: "));
                DefaultTableModel m = (DefaultTableModel) jTable2.getModel();
                id = (int) jTable2.getValueAt(fila, 0);
                descripcion = (String) jTable2.getValueAt(fila, 1);
                precio = (Float) jTable2.getValueAt(fila, 2);
                DefaultTableModel m2 = (DefaultTableModel) Orden.jTable2.getModel();
                int dup = duplicado(id);
                if (dup == -1) {
                        m2.addRow(new Object[]{id, descripcion, precio, a, (a * precio)});
                } else {
                    m2.setValueAt((Integer.parseInt(m2.getValueAt(dup, 3).toString()) + a), dup, 3);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(agregPlatoOrden.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new agregPlatoOrden().setVisible(true);
            }
        });
    }
